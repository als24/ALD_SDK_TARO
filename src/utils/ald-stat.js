!function (n, t) {
  ...
  function o(n) {
    var t;
    t = n.scene != cn, cn = n.scene, J = 0, Q = n, V = n.query.ald_share_src, W = n.query.aldsrc || "", z = n.query.ald_share_src, E = Date.now(), sn || ($ = !1), sn = !1, un || (0 !== B && Date.now() - B > 3e4 ? O = w() : t && (O = w())), 0 !== B && Date.now() - B < 3e4 && (tn = !0), n.query.ald_share_src && "1044" == n.scene && n.shareTicket ? wx.getShareInfo({
        ...
        if (n.authSetting["scope.userInfo"]) {
          wx.getUserInfo({
            withCredentials: !0, success: function (n) {
              var t = g();
              Y = n, t.ufo = S(n), j = v(n.userInfo.avatarUrl.split("/")), p(t)
            }
          })
        }
      }
    ...
    B = Date.now(), "" === Y && wx.getSetting({
      success: function (n) {
        n.authSetting["scope.userInfo"] && wx.getUserInfo({
          withCredentials: !0, success: function (n) {
            Y = n, j = v(n.userInfo.avatarUrl.split("/"));
            var t = g();
            t.ufo = S(n), p(t)
          }
        })
  ...
  function s() {
    en = C ? this.$mp.page.route : this.route, x("page", "show"), tn = !1
  }
  ...
  function h(n) {
    ...
    e.ald_share_src ? e.ald_share_src.indexOf(G) == -1 && e.ald_share_src.length < 200 && (e.ald_share_src = e.ald_share_src + "," + G) : e.ald_share_src = G;
    ...
    function t() {
      return new Promise(function (t, e) {
        wx.request({
          ...
          data: n,
          header: {AldStat: "MiniApp-Stat", se: T || "", op: N || "", img: j},
          method: "GET",
          success: function (n) {
  ...
  function m(n, t) {
    var e = g();
    e.ev = n, e.life = t, e.ec = F, e.st = Date.now(), e.dr = Date.now() - E, W && (e.qr = W, e.sr = W), V && (e.usr = V), p(e)
  }

  function x(n, t) {
    var e = g();
    e.ev = n, e.st = Date.now(), e.life = t, e.pp = en, e.pc = on, e.dr = Date.now() - E, un && (e.so = 1), un = !1, rn && "{}" != JSON.stringify(rn) && (e.ag = rn), W && (e.qr = W, e.sr = W), V && (e.usr = V), tn && (e.ps = 1), nn || (an = en, nn = !0, e.ifp = nn, e.fp = en), p(e)
  }

  function D(n, t, e) {
    var o = g();
    o.ev = n, o.tp = t, o.st = K, o.dr = Date.now() - E, e && (o.ct = e), p(o)
  }
  ...
  var H = require("./ald-stat-conf"), I = "7.2.2", U = "log", C = !1, O = "", b = "", E = 0, B = 0, T = "", N = "",
    j = "", J = 0, Q = "", $ = "", G = function () {
      var n = "";
      try {
      ...
      return n
    }(), K = Date.now(), V = "", W = "", z = "", F = 0, X = "", Y = "", Z = {}, nn = !1, tn = !1, en = "", on = "",
    rn = "", an = "", sn = !0, un = !1, cn = "";
  !function () {
    wx.request({
  ...
  try {
    ...
    Z.br = fn.brand, Z.pm = fn.model, Z.pr = fn.pixelRatio, Z.ww = fn.windowWidth, Z.wh = fn.windowHeight, Z.lang = fn.language, Z.wv = fn.version, Z.wvv = fn.platform, Z.wsdk = fn.SDKVersion, Z.sv = fn.system
  } catch (n) {
  }
  wx.getNetworkType({
    success: function (n) {
    ...
    if ("" !== n && "string" == typeof n && n.length <= 255) if ("string" == typeof t && t.length <= 255) D("event", n, t); else if ("object" == typeof t) {
  ...
  return H.plugin ? {App: L, Page: P, MpvueApp: R, MpvuePage: k} : function (n) {
    !function () {
      ...
      App = function (t) {
        ...
        A(n, "onLoad", a), A(n, "onUnload", c), A(n, "onShow", s), A(n, "onHide", u), A(n, "onReachBottom", l), A(n, "onPullDownRefresh", f), void 0 !== e && null !== e && (n.onShareAppMessage = function (n) {
          if (void 0 !== e) {
            var t = e.call(this, n);
            return void 0 === t ? (t = {}, t.path = en) : void 0 === t.path && (t.path = en), h(t)
          }
        }), t(n)
      }, Component = function (n) {
        var t = n.methods.onShareAppMessage;
        A(n.methods, "onLoad", a), A(n.methods, "onUnload", c), A(n.methods, "onShow", s), A(n.methods, "onHide", u), A(n.methods, "onReachBottom", l), A(n.methods, "onPullDownRefresh", f), void 0 !== t && null !== t && (n.methods.onShareAppMessage = function (n) {
          if (void 0 !== t) {
            var e = t.call(this, n);
            return void 0 === e ? (e = {}, e.path = en) : void 0 === e.path && (e.path = en), h(e)
          }
        }), d(n)
      }
    }()
